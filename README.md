...
- earlier recognition of minecount helpfulness; if the max number of mines near fronts + remaining cells is above remaining minecount, do not even start minecount, as it's impossible in this situation that minecount could solve anything. For this, I'd need the max possible number of mines in front early-on, before the minecount would be started normally
